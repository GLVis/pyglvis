...
var GlvisView = widgets.DOMWidgetView.extend({
    render: function() {
        ...
        this.canvas = glvis.setupCanvas(this.div, this.model.get('_width'), this.model.get('_height'));
    ...
    display: function() {
        ...
        glvis.display(this.div, this.canvas, this.model.get('_data_type'), this.model.get('_data_str'));
    }
});
